...
// Uses Divi formatting for included button styles.
...
class ASUSuperFooterEndorsedLogo extends Widget {
    ...
    function front_end( $args, $instance ) {
        ...
        if (! empty($instance['logo-contribute'])) {
            ...
            echo '<a class="et_pb_button et_pb_bg_layout_dark et_pb_button_contribute" href="' . $instance['logo-contribute'] . '" target="_blank">Contribute</a>';
            echo '</div>';
        }
    }
}
...
class ASUSuperFooterSocialMedia extends Widget {
    ...
    function front_end( $args, $instance ) {
        ...
        if (! empty($instance['sm-contribute'])) {
            echo '<div class="et_pb_button_module_wrapper et_pb_button_alignment_left et_pb_module">';
            echo '<a class="et_pb_button et_pb_bg_layout_dark et_pb_button_contribute" href="' . $instance['sm-contribute'] . '" target="_blank">Contribute</a>';
            echo '</div>';
        }
    }
}
